...
const randomize_data = () => {
  ...
  randomizedData.pressure_applied =
    Math.floor(Math.random() * (1100 - 900 + 1)) + 900; // Random between 900 and 1100
  ...
  randomizedData.weld_strength_estimate =
    Math.floor(Math.random() * (2100 - 1900 + 1)) + 1900; // Random between 1900 and 2100
  randomizedData.vibration_level = (Math.random() * (0.5 - 0.1) + 0.1).toFixed(
    2
  ); // Random between 0.1 and 0.5
  randomizedData.power_consumption = (Math.random() * (5 - 3) + 3).toFixed(2); // Random between 3 and 5
  randomizedData.force_applied =
    Math.floor(Math.random() * (550 - 450 + 1)) + 450; // Random between 450 and 550
  ...
  randomizedData.vibration_level = (Math.random() * (1.0 - 0.5) + 0.5).toFixed(
    2
  ); // Random between 0.5 and 1.0
  randomizedData.cycle_count =
    Math.floor(Math.random() * (1600 - 1400 + 1)) + 1400; // Random between 1400 and 1600
  randomizedData.oil_pressure = (Math.random() * (4 - 3) + 3).toFixed(2); // Random between 3 and 4
  randomizedData.sheet_thickness = (Math.random() * (1.5 - 1.0) + 1.0).toFixed(
    2
  ); // Random between 1.0 and 1.5
  randomizedData.noise_level = Math.floor(Math.random() * (90 - 80 + 1)) + 80; // Random between 80 and 90
  randomizedData.lubrication_flow_rate = (
    Math.random() * (1 - 0.5) +
    0.5
  ).toFixed(2); // Random between 0.5 and 1.0
  randomizedData.spray_pressure = (Math.random() * (5 - 2.5) + 2.5).toFixed(2); // Random between 2.5 and 5.0
  randomizedData.paint_thickness =
    Math.floor(Math.random() * (140 - 100 + 1)) + 100; // Random between 100 and 140
  ...
  randomizedData.paint_volume_used = (Math.random() * (1 - 0.5) + 0.5).toFixed(
    2
  ); // Random between 0.5 and 1.0
  randomizedData.atomizer_speed =
    Math.floor(Math.random() * (22000 - 18000 + 1)) + 18000; // Random between 18000 and 22000
  randomizedData.overspray_capture_efficiency =
    Math.floor(Math.random() * (100 - 90 + 1)) + 90; // Random between 90 and 100
  randomizedData.booth_airflow_velocity = (
    Math.random() * (0.6 - 0.4) +
    0.4
  ).toFixed(2); // Random between 0.4 and 0.6
  randomizedData.battery_level =
    Math.floor(Math.random() * (100 - 70 + 1)) + 70; // Random between 70 and 100
  randomizedData.load_weight =
    Math.floor(Math.random() * (600 - 400 + 1)) + 400; // Random between 400 and 600
  randomizedData.speed = (Math.random() * (2 - 1) + 1).toFixed(2); // Random between 1.0 and 2.0
  randomizedData.distance_traveled =
    Math.floor(Math.random() * (1500 - 1000 + 1)) + 1000; // Random between 1000 and 1500
  randomizedData.temperature = Math.floor(Math.random() * (40 - 30 + 1)) + 30; // Random between 30 and 40
  randomizedData.wheel_rotation_speed =
    Math.floor(Math.random() * (500 - 300 + 1)) + 300; // Random between 300 and 500
  randomizedData.spindle_speed =
    Math.floor(Math.random() * (13000 - 10000 + 1)) + 10000; // Random between 10000 and 13000
  randomizedData.tool_wear_level =
    Math.floor(Math.random() * (40 - 30 + 1)) + 30; // Random between 30 and 40
  ...
  randomizedData.vibration_level = (Math.random() * (1.5 - 1.0) + 1.0).toFixed(
    2
  ); // Random between 1.0 and 1.5
  randomizedData.coolant_flow_rate = (Math.random() * (1 - 0.5) + 0.5).toFixed(
    2
  ); // Random between 0.5 and 1.0
  randomizedData.material_hardness =
    Math.floor(Math.random() * (220 - 200 + 1)) + 200; // Random between 200 and 220
  ...
  randomizedData.pressure_drop = (Math.random() * (0.05 - 0.01) + 0.01).toFixed(
    2
  ); // Random between 0.01 and 0.05
  ...
  randomizedData.fluid_type =
    Math.random() < 0.5 ? "air" : Math.random() < 0.5 ? "water" : "oil"; // Randomly choose fluid type
